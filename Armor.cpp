...
// Armor constructors
Armor::Armor() : Item() {}
Armor::Armor(string name, Enhancement enhancement) {
    this->name = name;
...
Armor::Armor(string name, EnhancementType enhancementType, int enhancementBonus) {
...
bool Armor::setEnhancement(Enhancement enhancement) {
...
bool Armor::setEnhancementBonus(int enhancementBonus) {
...
bool Armor::setEnhancementType(EnhancementType enhancementType) {
    if (enhancementType == armorClass) {
